...
public class UbicacionGeograficaService {
	...
	public UbicacionGeografica consultarUbicacionGeograficaPorID(Integer codigoUbicacionGeografica){
		return this.ubicacionGeograficaDao.obtenerPorCodigo(codigoUbicacionGeografica);
	}
}
